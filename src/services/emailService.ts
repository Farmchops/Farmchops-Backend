...
Thank you for choosing Farmchops
  ...
  async sendMarketerWelcomeEmail(
    email: string,
    marketerData: {
      firstName: string;
      lastName: string;
    ...
    try {
      const supportEmail = resolveSupportEmail();
      const { firstName, lastName, marketingCode, commissionRate } = marketerData;

      const subject = "Welcome to Farmchops Marketing Team";
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="message">
                ...
                We're excited to have you on board and look forward to a successful partnership.
            </div>
            ...
            <div class="info-box">
                ...
                <div class="info-item">
                    ...
                    <span class="info-value">${commissionRate}%</span>
                </div>
                <div class="info-item">
            ...
            <div class="section">
                ...
                <div class="message" style="text-align: center; font-style: italic;">
            ...
            <div class="instructions">
                <div style="font-weight: bold; margin-bottom: 10px;">💬 Example for Customers:</div>
                <div style="font-style: italic;">
                    "Sign up at farmchops.com and use referral code <strong>${marketingCode}</strong>
                    to get 10% off your first order! Fresh farm produce delivered to your doorstep."
                </div>
            </div>
            ...
            <div class="section">
                ...
                <div class="message">
                    You will receive monthly performance reports via email showing your signups,
                    orders, revenue generated, and commission earned. For any questions or to
                    request additional reports, contact your manager or email us at ${supportEmail}.
                </div>
            </div>
...
"Sign up at farmchops.com and use referral code ${marketingCode}
...
You will receive monthly performance reports via email.
